...
STAGES = [
    {
        ...
        "title": "まほうの どうぶつの もり",
        "mistakes": [
            {"id": 1, "x": 34.8, "y": 7.9, "w": 10.0, "h": 10.0},
            {"id": 2, "x": 37.1, "y": 24.6, "w": 7.0, "h": 9.0},
            {"id": 3, "x": 34.2, "y": 59.0, "w": 12.0, "h": 17.0},
            {"id": 4, "x": 77.1, "y": 65.2, "w": 7.0, "h": 9.0},
            {"id": 5, "x": 22.0, "y": 30.0, "w": 7.0, "h": 8.0}
        ]
    },
    {
        "level": 2,
        "title": "おひめさまの おしろ",
        "mistakes": [
            {"id": 1, "x": 64.4, "y": 42.0, "w": 12.0, "h": 10.0},
            {"id": 2, "x": 89.2, "y": 45.8, "w": 14.0, "h": 14.0},
            {"id": 3, "x": 10.8, "y": 80.6, "w": 18.0, "h": 18.0}
        ]
    },
    {
        "level": 3,
